    ...
    */
    ...
    $.addFlex = function (t, p) {
        ...
        p = $.extend({ //apply default properties
            ...
            title: false,
            idProperty: 'id',
            pagestat: 'Näytetään {from} - {to} / {total} kohteesta',
            pagetext: 'Sivu',
            outof: '/',
            daterangetext: 'Aikaväli',
            findtext: 'Etsi',
            params: [], //allow optional parameters to be passed around
            procmsg: 'Ladataan, ole hyvä ja odota...',
            startdate: '',
            enddate: '',
            query: '',
            qtype: '',
        ...
        var g = {
            ...
            doSearch: function () {
                p.startdate = $('input[name=startdate]', g.sDiv).val();
                p.enddate = $('input[name=enddate]', g.sDiv).val();
        ...
        if (p.usepager) {
            ...
            if (p.searchitems) {
                ...
                $(g.sDiv).append("<div class='sDiv2'>" +
                        p.daterangetext +
                        " <input type='date' value='" + p.startdate + "' name='startdate' /> " +
                        "-" +
                        " <input type='date' value='" + p.enddate + "' name='enddate' /> " +
                        p.findtext +
						" <input type='text' value='" + p.query + "' size='30' name='q' class='qsbox' /> " +
						" <select name='qtype'>" + sopt + "</select> " +
                        " <div class='btnsearch'><span>Hae</span></div></div>");
                ...
                $('input[name=startdate]', g.sDiv).change(function (e) {
                    g.doSearch();
                });
                $('input[name=enddate]', g.sDiv).change(function (e) {
                    g.doSearch();
                });
                $('.btnsearch', g.sDiv).click(function (e) {
                    g.doSearch();
                });
