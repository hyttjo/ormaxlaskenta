                    <table id="batch_edit_table" class="full-width padding-20px background-black">
                        <tr>
                            <th>Taulukko</th>
                        ...
                        <tr>
                            ...
                            <td>
								<select id="first_column_selection">
                                    ...
                                    <option value="tiili" class="option-tarjoukset option-tilaukset option-lisatarviketarjoukset">Tiili</option>
                            ...
                            <td>
								<select id="logic_selection">
                                    ...
                                    <option value="replace">KORVAA</option>
                                </select>
							</td>
                            <td>
                            ...
                            <tr>
								<td colspan="6">
								    <button class="pure-button button-error margin-top-20px">Suorita</button>
								</td>
                            </tr>
                        </tr>
                    </table>