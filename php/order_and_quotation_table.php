...
?>
        <table id="info-table" class="pure-table table-condensed full-width centered border" data-id="">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td id="table-vergeSolution" class="table-value">
                        <input type="text"><span><?php echo $vergeSolution ?></span>
                    </td>
                </tr>
            </tbody>
        </table>